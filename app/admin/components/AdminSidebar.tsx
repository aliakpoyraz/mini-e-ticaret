...
import { LayoutDashboard, ShoppingBag, Package, Plus, Store, Settings, LogOut, Users, Percent, RotateCcw } from 'lucide-react';
            ...
            <div className="p-4 border-t border-slate-100">
                ...
                >
                    ...
                    <div className="flex-1">
                        <p className="text-sm font-bold text-slate-900">Yönetici</p>
                        <p className="text-xs text-[#86868B]">admin@store.com</p>
                    </div>
                    <div className="w-8 h-8 rounded-full flex items-center justify-center group-hover:bg-red-50 transition-colors duration-300">
                        <LogOut size={16} strokeWidth={2.5} className="text-[#86868B] group-hover:text-red-500 transition-colors duration-300" />
                    </div>
                </button>
            </div>
        </aside>
