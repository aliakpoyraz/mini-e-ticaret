...
export default function NewDiscountForm({ products }: { products: any[] }) {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">Yeni İndirim</h1>
                    <p className="text-sm text-slate-500">Müşterileriniz için yeni bir indirim kuralı oluşturun.</p>
                </div>
            </div>

            <form action={createDiscount} className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 space-y-8">
                <div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input name="name" type="text" required placeholder="Örn: Yaz İndirimi" className="w-full border border-gray-200 p-2.5 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none transition bg-white text-gray-900 text-sm" />
                        </div>
                        ...
                        <div className="flex flex-col gap-4 mt-4">
                            {conditionType === 'PRODUCT' && (
                                <div>
                                    ...
                                    <select name="productId" className="w-full border border-gray-200 p-2.5 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none transition bg-white text-gray-900 text-sm appearance-none cursor-pointer" style={{ backgroundImage: "url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e\")", backgroundPosition: "right 0.5rem center", backgroundRepeat: "no-repeat", backgroundSize: "1.5em 1.5em", paddingRight: "2.5rem" }}>
